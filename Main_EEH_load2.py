...
def processData(data, line, n, isComment, folder, markers, marker1) :
    logging.debug("markers: " + str(markers))
    logging.debug("marker1: " + str(marker1))
    ...
    if (line == 1):
        data1 = pd.DataFrame(energy, columns=[names[n]]).T.to_excel(writer, sheet_name=u'Energy',
                                                                     ...
                                                                     header=False)
        data2 = pd.DataFrame(entropy, columns=[names[n]]).T.to_excel(writer, sheet_name=u'Entropy',
                                                                      startrow=(line - 1) * 5 + n + 1, startcol=1,
                                                                      header=False)
        data3 = pd.DataFrame(hurstl, columns=[names[n]]).T.to_excel(writer, sheet_name=u'Hurst',
                                                                     startrow=(line - 1) * 5 + n + 1, startcol=1,
                                                                     header=False)
    else:
...
#         processData(data, line, n, True, '01', markers, marker1)
#
# #-----------------------------------------------------------------------------------------------------------------------
# #01 After
# #-----------------------------------------------------------------------------------------------------------------------
...
for line in [1]:
    for n in range(10):
        ...
        data2 = data2.drop(data2[data2.stad == '0'].index)
        data2 = data2.reset_index()
        data3 = data3.drop(data3[data3.stad == '0'].index)
        ...
        lol3 = data3.groupby('stad')
        c3 = [lol3.get_group(x) for x in lol3.groups]
        markers3 = [max(j.index) for j in c3]
        markers3 = np.sort(markers3)

        markers = list(markers1) + list(markers2)+ list(markers3 + markers2[-1])
...
#         markers = list(markers1) + list(markers2 + markers1[-1])
#
#         marker1 = [u'ГЗ', u'ГЗ_end', u'1', u'1', u'2', u'2', u'3', u'3', u'4', u'4', u'5', u'5', u'1', u'1', u'2', u'2', u'3', u'3', u'4', u'4', u'5',
...
#         markers = np.sort(markers)
#         marker1 = [u'ГЗ', u'ГЗ_end', u'1', u'1', u'2', u'2', u'3', u'3', u'4', u'4', u'5', u'5', u'6', u'6', u'7', u'7', u'8', u'8', u'9', u'9', u'10',
#                    u'1', u'1', u'2', u'2', u'3', u'3', u'4', u'4', u'5', u'5', u'6', u'6', u'7', u'7', u'8', u'8', u'9', u'9', u'10']
